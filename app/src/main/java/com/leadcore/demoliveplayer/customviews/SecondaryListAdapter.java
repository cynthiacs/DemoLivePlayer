...
public abstract class SecondaryListAdapter<GVH, SVH extends RecyclerView.ViewHolder> extends RecyclerView
    ...
    private final static String TAG = "SecondaryListAdapter";
    ...
    public final void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        Log.d(TAG, "onBindViewHolder: position = "+position+", itemStatus = "+itemStatus.getViewType());
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if ( !groupItemStatus.get(groupItemIndex) ) {
                        ...
                        Log.d(TAG, "false:position = "+holder.getAdapterPosition()+",subsize = "+dt.getSubItems().size());
                        ...
                        Log.d(TAG, "true:position = "+holder.getAdapterPosition()+",subsize = "+dt.getSubItems().size());
    ...
    public final int getItemCount() {
        ...
        Log.d(TAG, "getItemCount return "+itemCount);
